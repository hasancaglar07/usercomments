...
:: TURBO MODE SETTINGS
:: Increased throughput for faster ingestion
set MAX_NEW_REVIEWS_PER_LOOP=5
set DAILY_REVIEW_LIMIT=2000
set LOOP_MIN_SECONDS=30
set LOOP_MAX_SECONDS=60

echo [info] Running in TURBO MODE (5 reviews/loop, 30-60s wait)
